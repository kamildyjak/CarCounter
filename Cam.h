...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Cam::typeid));
			...
			this->button2->Text = L"Zawnêtrzna";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Cam::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Text = L"Wbudowana";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Cam::button1_Click);
			// 
			// textBox1
			// 
			...
			this->textBox1->Text = L"Typ kamery";
